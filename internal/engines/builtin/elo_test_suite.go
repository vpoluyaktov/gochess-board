...
func GetTacticalTestSuite() []TacticalPosition {
	return []TacticalPosition{
		...
		},
		{
			...
			BestMoves:   []string{"e5f7", "Nxf7", "d1h5", "Qh5"},
			Description: "Knight fork or Qh5 threatens mate",
			Difficulty:  2,
		},
		{
			Name:        "Pin",
			FEN:         "r2qkb1r/ppp2ppp/2n1pn2/3p4/2PP2b1/2N2N2/PP2PPPP/R1BQKB1R w KQkq - 0 1",
			BestMoves:   []string{"c4d5", "cxd5", "d1a4", "Qa4"},
			Description: "Capture pawn or Qa4 pins knight",
			Difficulty:  1,
		},
		{
			Name:        "Passed Pawn",
			FEN:         "8/8/8/3k4/8/4K3/3P4/8 w - - 0 1",
			BestMoves:   []string{"d2d4", "d4", "d2d3", "d3", "e3d3", "Kd3"},
			Description: "Push passed pawn or king escort",
			Difficulty:  1,
		},
		{
			Name:        "Promotion",
		...
		},
		{
			...
			BestMoves:   []string{"g5f6", "Bxf6", "c4f7", "Bxf7+", "c3d5", "Nd5", "c3b5", "Nb5"},
			Description: "Bishop takes knight, Bxf7+, Nd5, or Nb5",
			Difficulty:  2,
		},
		{
			Name:        "Skewer",
			FEN:         "r1bqk2r/pppp1ppp/2n5/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQ1RK1 b kq - 0 1",
			BestMoves:   []string{"c5f2", "Bxf2+", "d8g5", "Qg5"},
			Description: "Bishop check skewer or Qg5 attack",
			Difficulty:  2,
		},
	}
}
